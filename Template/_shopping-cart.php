            ...
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-raleway w-25">
                                <button class="qty-up border bg-light"><i class="fas fa-angle-up"
                                                                          data-id="pro2"></i></button>
                                <input type="text" class="qty_input border px-2 w-100 bg-light"
                                       data-id="pro2" disabled value="1" placeholder="1">
                                <button class="qty-down border bg-light"><i class="fas fa-angle-down"
                                                                            data-id="pro2"></i></button>
                            </div>
                            <button type="submit" class="btn font-baloo text-danger px-3 border-right">Delete</button>
                            <button type="submit" class="btn font-baloo text-danger">Save for Later</button>
