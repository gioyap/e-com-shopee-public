        ...
        <div class="row">
                        ...
                        <div class="row border-top py-3 mt-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                        <input type="hidden" value="<?php echo isset($item['item_id']) ? $item['item_id'] : 0; ?>" name="item_id">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-raleay text-success py-3"><i class="fas fa-check"></i> Your order is eligible for FREE Delivery.</h6>
